...
from api_schemas.example_schema import FruitCreate, FruitRead, FruitUpdate
...
@fruit_router.post("/", response_model=FruitRead)
...
@fruit_router.delete("/{fruit_id}", response_model=FruitRead)
...
@fruit_router.patch("/{fruit_id}", response_model=FruitRead)
